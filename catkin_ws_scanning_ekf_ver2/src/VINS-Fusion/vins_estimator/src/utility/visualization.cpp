...
void pubCameraPose(const Estimator &estimator, const std_msgs::Header &header)
{
    ...
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        // if (1) // Lidar
        // {
        //     Eigen::Matrix3d mRLidar2Cam;
        //     Eigen::MatrixXd mtLidar2Cam(3,1);
        ...
        //     //Vector3d P = estimator.Ps[i] + estimator.Rs[i] * estimator.tic[0] ;
        //     Vector3d P = estimator.Ps[i] + estimator.Rs[i] * (estimator.ric[0] * mtLidar2Cam + estimator.tic[0]);
        //     Quaterniond R = Quaterniond(estimator.Rs[i] * estimator.ric[0] * mRLidar2Cam);

        //     cameraposevisual.add_lidar_pose(P, R);
        // }
